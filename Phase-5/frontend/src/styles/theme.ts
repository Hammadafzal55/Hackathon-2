// Design tokens for the UI enhancement
...
export const lightThemeValues = {
  ...
  '--color-text-secondary': designTokens.colors.neutral[600],
  '--color-border': designTokens.colors.neutral[200],
  '--color-accent': designTokens.colors.primary[500],
};
...
export const darkThemeValues = {
  ...
  '--color-text-secondary': designTokens.colors.neutral[400],
  '--color-border': designTokens.colors.neutral[700],
  '--color-accent': designTokens.colors.primary[400],
};
